...
var margin = {
  ...
  height = $('.grid').width() - margin.top - margin.bottom;
var rect = {
  width: 200,
  height: 100,
  rx: 6,
 ...
 * @param  {[String]} type [type: "log", "error", "debug", "info"]
...
var treeCtrl = app.controller('treeCtrl', function() {
